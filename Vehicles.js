...
// Example markers across multiple countries
const vehicles = [
    {lat:40.730610, lng:-73.935242}, {lat:48.8566, lng:2.3522}, {lat:51.5074, lng:-0.1278}
];
const airplanes = [
    {lat:34.0522, lng:-118.2437}, {lat:35.6895, lng:139.6917}, {lat:55.7558, lng:37.6173}
];
